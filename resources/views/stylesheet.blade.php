...
<!--right slidebar-->
  ...
  <!--Form Wizard-->
  <link rel="stylesheet" type="text/css" href="{{URL::to('/')}}/css/jquery.steps.css" />
  ...
  <link rel="stylesheet" href="{{URL::to('/')}}/css/helper.css" media="screen" title="no title" charset="utf-8">
